...
mkdir -p deploy/samza
tar -xvf ./target/hello-samza-0.10.0-dist.tar.gz -C deploy/samza
scp -r . hadoop-client01.dev.aws.mgnt.cc:/srv/stanislav/samza/hello-samza
ssh hadoop-client01.dev.aws.mgnt.cc
export HADOOP_CONF_DIR=/etc/hadoop/conf
cd /srv/stanislav/samza/hello-samza
hadoop fs -put ./target/hello-samza-0.10.0-dist.tar.gz samza
